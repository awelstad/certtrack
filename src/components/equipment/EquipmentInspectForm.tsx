...
import { submitInspection } from '@/app/actions/equipment'
...
export function EquipmentInspectForm({ equipmentId, templates, initialInspectorName = '' }: Props) {
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      const res = await submitInspection(null, fd)
      if (res.error) {
        setError(res.error)
      } else {
            ...
            {items.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Pass / Fail / N/A — large tap targets */}
